...
echo -e "${INFO_LABEL}DOCKER_SCRIPTS_DIR: $DOCKER_SCRIPTS_DIR"
echo -e "${INFO_LABEL}EXERCISE_DIR: $EXERCISE_DIR"
echo -e "${INFO_LABEL}CLIENT_CONTAINER_NAME: $CLIENT_CONTAINER_NAME"
echo -e "${INFO_LABEL}SERVER_CONTAINER_NAME: $SERVER_CONTAINER_NAME"
